...
- 动态规划
title: 动态规划
updated: '2026-07-26T21:45:58.589+08:00'
---
# 动态规划
...
**状态压缩动态规划（State Compression DP）是一种将集合状态用二进制数编码的动态规划技术，核心思想是用整数的二进制位表示元素的选中状态（如第i位为1表示第i个元素被选中），从而将集合操作转化为高效的位运算。它适用于状态中包含****小规模集合信息**的问题（通常元素数量≤20，因2²⁰≈1e6在可接受范围内），典型场景包括集合覆盖、排列组合优化、图论中的子集路径问题等。**
